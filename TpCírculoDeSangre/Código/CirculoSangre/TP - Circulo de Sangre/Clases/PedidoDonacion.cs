...
namespace TP___Circulo_de_Sangre
{
    public class PedidoDonacion
    {
        ...
        { 
            get => grupoSangre; 
            set => grupoSangre = value; 
        }
        private int CantSolicitadaDonantes 
        { 
            get => cantSolicitadaDonantes; 
            set => cantSolicitadaDonantes = value; 
        }
        private DateTime FechaDeSolicitud 
        { 
            get => fechaDeSolicitud; 
            set => fechaDeSolicitud = value; 
        }
